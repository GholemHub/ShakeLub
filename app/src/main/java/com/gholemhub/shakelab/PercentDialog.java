...
//BUILDER OF OUR DIALOG
        builder.setView(view).setTitle("").setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                for (NoteIngredientAdapter.NoteIngredientsViewHolder list: NoteIngredientAdapter.nivhList) {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                for (NoteIngredientAdapter.NoteIngredientsViewHolder list: NoteIngredientAdapter.nivhList) {
                    ...
                    if(ingredientNum == Integer.parseInt(num)){
                        ...
                        NoteIngredient note =  NoteIngredientAdapter.mNoteIngredientsList.get(ingredientNum-1);
